...
class level1FightScene extends Phaser.Scene {
    ...
    create(){
        ...
        //player
        this.player = {
            obj: this.physics.add.sprite(game.config.width/2, game.config.height/2, 'white square').setAlpha(0.3).setScale(0.5),
            charge_progress: 0,
            dashing: false,
    ...
    spawnEnemy(type){
        ...
        switch(type){
            ...
            case "GOLEM":
                ...
                break;
            case "SHOOTER":
                new_enemy = new ShooterEnemy(this, game.config.width/3, 140, 'white square').setTint(0xaaaa00);
                break;
            default: 
    ...
    updateEnemies(time, delta){
        //console.log(this.enemy_projectiles.getChildren());
