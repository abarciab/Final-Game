class level1FightScene extends Phaser.Scene {
    ...
    addColliders() {
        ...
        //this.physics.add.collider(this.enemies, this.enemy_shockwaves, enemyShockwaveCollision.bind(this));
        ...
        this.physics.add.collider(this.enemy_projectiles.getChildren(), this.targets, function(projectile, target) {
